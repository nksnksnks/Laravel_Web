...
<!-- calendar -->
<link rel="stylesheet" href="public/back-end/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-category-product')}}">Thêm danh mục</a></li>
						<li><a href="{{URL::to('/all-category-product')}}">Danh sách danh mục</a></li>
                    </ul>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-brand-product')}}">Thêm thương hiệu</a></li>
						<li><a href="{{URL::to('/all-brand-product')}}">Danh sách thương hiệu</a></li>
                    </ul>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-product')}}">Danh sách sản phẩm</a></li>
                    </ul>
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-glass"></i>
                        <span>Màu sắc sản phẩm</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-color')}}">Thêm màu sắc</a></li>
						<li><a href="{{URL::to('/all-color')}}">Danh sách màu sắc</a></li>
                    </ul>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/admin-manage-order')}}">Quản lý đơn hàng</a></li>
                        <li><a href="{{URL::to('/admin-manage-order')}}">Đơn hàng đang giao</a></li>
                    </ul>
    ...
    <script>
        function validateFile(input) {
            ...
            if (!allowedExtensions.exec(file.name)) {
                alert('File không hợp lệ. Vui lòng chọn file ảnh có định dạng .png, .jpg hoặc .jpeg.');
                input.value = '';
                return false;
            }
            ...
            if (fileSize > maxSize) {
                alert('Kích thước file quá lớn. Vui lòng chọn một file nhỏ hơn 5MB.');
                input.value = '';
                return false;
            }
